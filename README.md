...
![Метрики приложения](monitoring/deployed app metrics.jpg)
![Метрики ingress контроллера](monitoring/nginx ingress controller.jpg)
![Метрики пода](monitoring/pod.jpg)
