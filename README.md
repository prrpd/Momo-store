...
Магазин доступен по адресу http://w.nuf1.fun/
...
После развертывания инфраструктуры (terraform apply с компьютера), внешний IP-адрес балансировщика, созданного автоматически при установке nginx ingress controller, указывается в A-записи DNS зоны, соответствующей домену магазина пельменей.
